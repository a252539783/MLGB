...
JNIEXPORT jboolean JNICALL Java_mobile_xiyou_hook_Native_munprotect(JNIEnv *env, jclass _cls, jlong addr, jlong len) {
...
JNIEXPORT void JNICALL Java_mobile_xiyou_hook_Native_memcpy(JNIEnv *env, jclass _cls, jlong src, jlong dest, jint length) {
...
JNIEXPORT void JNICALL Java_mobile_xiyou_hook_Native_memput(JNIEnv *env, jclass _cls, jbyteArray src, jlong dest) {
...
JNIEXPORT jbyteArray JNICALL Java_mobile_xiyou_hook_Native_memget(JNIEnv *env, jclass _cls, jlong src, jint length) {
...
JNIEXPORT jlong JNICALL Java_mobile_xiyou_hook_Native_mmap(JNIEnv *env, jclass _cls, jint length) {
...
JNIEXPORT jboolean JNICALL Java_mobile_xiyou_hook_Native_munmap(JNIEnv *env, jclass _cls, jlong addr, jint length) {
...
JNIEXPORT void JNICALL Java_mobile_xiyou_hook_Native_ptrace(JNIEnv* env, jclass _cls, jint pid) {
